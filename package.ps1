...
Compress-Archive -Path dist/MSXMusicAlchemy -DestinationPath releases/MSXMusicAlchemy-v0.1.0-windows-x64.zip -Force
Get-FileHash releases/MSXMusicAlchemy-v0.1.0-windows-x64.zip -Algorithm SHA256
