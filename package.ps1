...
Compress-Archive -Path dist/MSXMusicAlchemy -DestinationPath releases/MSXMusicAlchemy-v0.4.0-windows-x64.zip -Force
Get-FileHash releases/MSXMusicAlchemy-v0.4.0-windows-x64.zip -Algorithm SHA256
